...
const syncGitHubSkills = () => {
    ...
    router.post('/profile/sync-github-skills', {}, {
        onFinish: () => {
            syncing.value = false;
        }
    });
                    ...
                    <CardHeader>
                        <div class="flex items-center justify-between">
                            ...
                            <button
                                ...
                                :disabled="syncing"
                                class="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-md hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 disabled:opacity-50 transition-colors"
                            >
