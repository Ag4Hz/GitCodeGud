                    ...
                    <form @submit.prevent="submitBounty" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea
                                ...
                                rows="4"
                                :class="[
                                    'flex min-h-[80px] w-full rounded-2xl border border-gray-200 bg-white/40 p-4 text-sm font-medium shadow-sm backdrop-blur-xl backdrop-saturate-150 placeholder:text-muted-foreground focus-visible:border-green-500 focus-visible:ring-2 focus-visible:ring-green-500/50 focus-visible:outline-none sm:backdrop-blur-2xl dark:border-white/10 dark:bg-white/10 dark:text-gray-100 dark:focus-visible:border-ring dark:focus-visible:ring-ring/50',
                        ...
                        <img
                            ...
                            alt="sitting bug"
                            class="absolute top-[-458px] z-50 translate-x-[-350px] -scale-x-[-1] scale-[0.15] [transform:rotateY(180deg)] drop-shadow-[0_-10px_15px_rgba(255,255,255,0.1)]"
                        />
