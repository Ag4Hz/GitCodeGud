            ...
            <div class="mx-auto flex h-18 items-center px-4 md:max-w-7xl">
                            ...
                            <NavigationMenuItem v-for="(item, index) in mainNavItems" :key="index" class="relative flex h-full items-center">
                                <Link
                                    :class="[
                                        ...
                                        'h-9 cursor-pointer bg-white/40 backdrop-blur-xl dark:bg-white/5',
                                    ]"
                                    :href="item.href"
                                >
                ...
                <div class="ml-auto flex items-center space-x-2">
                    <Button v-if="!isAuthenticated" as-child size="sm">
                        <Link :href="route('login')" class="flex items-center gap-1 sm:gap-2">
                            <LogIn class="size-4" />
                            <span class="text-xs sm:text-sm">Login</span>
                        </Link>
                    </Button>

                    <Button v-if="!isAuthenticated" variant="ghost" as-child size="sm">
                        <Link :href="route('register')" class="btn-register flex items-center gap-1 sm:gap-2">
                    ...
                    <template v-else>
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" class="w-56 bg-white/40 backdrop-blur-xl dark:bg-white/5">
